...
// Hash: 6155ddcf116598b85933b75b846cce44025eac3ca7ed798e8643c9f576d9076e
package altair
...
func (c *ContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	if err = c.Contribution.UnmarshalSSZ(buf[8:153]); err != nil {
		return err
	}

	// Field (2) 'SelectionProof'
	if cap(c.SelectionProof) == 0 {
		c.SelectionProof = make([]byte, 0, len(buf[153:249]))
	}
	c.SelectionProof = append(c.SelectionProof, buf[153:249]...)
...
func (s *SyncCommitteeContribution) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.AggregationBits) == 0 {
		s.AggregationBits = make([]byte, 0, len(buf[48:49]))
	}
	s.AggregationBits = append(s.AggregationBits, buf[48:49]...)

	// Field (4) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[49:145]))
	}
	s.Signature = append(s.Signature, buf[49:145]...)
...
func (s *SignedContributionAndProof) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Message.UnmarshalSSZ(buf[0:249]); err != nil {
		return err
	}

	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[249:345]))
	}
	s.Signature = append(s.Signature, buf[249:345]...)
...
func (l *LightClientSnapshot) UnmarshalSSZ(buf []byte) error {
	...
	if err = l.CurrentSyncCommittee.UnmarshalSSZ(buf[112:1696]); err != nil {
		return err
	}
	...
	if err = l.NextSyncCommittee.UnmarshalSSZ(buf[1696:3280]); err != nil {
		return err
	}
...
func (l *LightClientUpdate) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'FinalityHeader'
	if l.FinalityHeader == nil {
		l.FinalityHeader = new(BeaconBlockHeader)
	}
...
func (l *LightClientUpdate) UnmarshalSSZ(buf []byte) error {
	...
	if err = l.NextSyncCommittee.UnmarshalSSZ(buf[112:1696]); err != nil {
		return err
	}
	...
	if err = l.FinalityHeader.UnmarshalSSZ(buf[1696:1808]); err != nil {
		return err
	}
