...
// Hash: b7b6eb75e56eab07cc8c646c43821df3fb11f675f46798860495dd88c9f566ee
package altair
...
func (l *LightClientSnapshot) UnmarshalSSZ(buf []byte) error {
	...
	if err = l.NextSyncCommittee.UnmarshalSSZ(buf[24736:49360]); err != nil {
		return err
	}
...
func (l *LightClientUpdate) UnmarshalSSZ(buf []byte) error {
	...
	if err = l.FinalityHeader.UnmarshalSSZ(buf[24736:24848]); err != nil {
		return err
	}
